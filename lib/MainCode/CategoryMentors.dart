...
import 'package:hackhive/MainCode/UserBooKSlot/BookSlot.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

class AllCategoryMentors extends StatefulWidget {
  String category = '';
  AllCategoryMentors({required this.category});

  @override
  State<AllCategoryMentors> createState() => _AllCategoryMentorsState();
}

class _AllCategoryMentorsState extends State<AllCategoryMentors> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('All Category Mentor'),
      ),
      body: _isLoading
  ...
  Future<void> fatchData() async {
    ...
    final url = 'https://hackhive-justcoders.onrender.com/api/user/getMentorListCategorywise?profession=${widget.category}';
